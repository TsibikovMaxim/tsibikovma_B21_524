...
img1) Для каждого пикселя изображения вычисляется среднее значение интенсивности в его окрестности. 
Эта окрестность может быть задана, например, квадратным или круглым окном определенного размера.

img2) Вычисляется весовой коэффициент для каждого пикселя в окрестности, 
который может зависеть от различных факторов, таких как расстояние до центрального пикселя или 
разность интенсивностей.

img3) На основе среднего значения интенсивности и весовых коэффициентов вычисляется адаптивный порог для 
